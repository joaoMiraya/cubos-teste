...
import type { CreateMovieType } from "../../types/movie.types";
...
export const CreateForm = ({ setShow }: Props) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const movieData: CreateMovieType = {
      ...formData,
    ...
    try {
      const response = await create(movieData);
        if (response.success) {
            return handleCancel();
        } else {
            setError("Erro ao criar filme. " + response.error);
            console.error("Erro ao criar filme:", response.error);
        }
    } catch (error) {
        setError("Erro ao criar filme. Por favor, tente novamente.");
